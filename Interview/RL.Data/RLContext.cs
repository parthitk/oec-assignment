...
public class RLContext : DbContext
{
    ...
    protected override async void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            typeBuilder.HasKey(up => new { up.PlanId, up.ProcedureId, up.UserId });
            typeBuilder.HasOne(pp => pp.Plan).WithMany(up => up.UserProcedures);
            typeBuilder.HasOne(up => up.User).WithMany();
        });
